...
| Vm0 | 2.5 - isfFactor×0.2 + activity×0.3 | 论文值mg/kg/min, 活动小幅提升 |
| VmX | 0.05 - isfFactor×0.01 | 论文值mg/kg/min per pmU/L |
| hepaticBase | 2.07 + isfFactor×0.4 | 重平衡稳态Gb=7.0 |
| kp3 | 0.045 - isfFactor×0.007 | 抵抗→胰岛素起效慢 |

> ★ v3.0.20 修复: App 默认参数下 Vm0=4.25 比 DallaMan 2007 论文值 2.5 高 70%，即使无输入血糖也持续下降到约 6 mmol/L (vs 期望 Gb=7.0 稳态)。修正: Vm0 4.5→2.5, Km0 25→100, VmX 0.16→0.05, k1 0.040→0.060, hepaticBase 1.8→2.07。4 场景 240min Python 验证通过，稳态正确回到 Gb=7.0。
